...
namespace RegexParser
{
	...
	{
		public static Function RegConstant = null;
		internal static Function RegVariable = null;
		...
		public object Solve(object[] Inputs)
		{
			if(RegConstant == null)
				throw new InvalidOperationException(
					"Function.RegConstant needs to be instantiated before Functions can be used.");
